<template>
     <div
              >
                  ...
                  <ul class="check-list">
                    <li>
                      <div class="stolen-check-box">✓</div>
                        <div class="delete-line">Lista de bicicletas em Cicla</div>
                    </li>
                    <li>
                      <div class="stolen-check-box-null"></div>
                      <div>
                      Reporte o furto na Cicla, 
                    ...
                    <li>
                      ...
                      <div class="delete-line">
                        add
                        <a href="javascript:void(0)" class="stolen-check-box-link"
                          >Adicione uma fotografia da sua bicicleta</a
                        >
                      </div>
                    </li>
                    <li>
                    ...
                    <li class="ps-5">
                      <div class="stolen-check-box-null"></div>
                      <div>
                       Enviar informação para as bases de dados políciais
                      </div>
                    </li>
                    <li>
                      <div class="stolen-check-box-null"></div>
                    ...
                    <li>
                      ...
                      <div>
                        <a href="javascript:void(0)" class="stolen-check-box-link"
                          >Partilhar no Twitter (A Cicla irá partilhar assim que o processo seja validado) </a
                        >
                      </div>
                    </li>
                    <li>
                     ...
                     <li>
                      <div class="stolen-check-box-null"></div>
                      <div>
                        Acelerar a partilha no Facebook com os Alertas Promovidos de Bicicletas Furtadas Cicla
                      </div>
                    </li>
                  </ul>
                </div>
                <div class="admin-tab-content">
                  <div class="section-title pb-4">
                    <h4 class="them-title-black mb-0">SHARE ON SOCIAL MEDIA</h4>
                  </div>
                  <p>
                  ...
                  <ul class="ps-0 row justify-content-around social-media">
                    <li class="col-12 col-md-6">
                      <a href="javascript:void(0)" class="facebook text-white"
                        ><i class="fab fa-facebook-f"></i> Share on Facebook
                      </a>
                    </li>
                    <li class="col-12 col-md-6 mob-mt">
                      <a href="javascript:void(0)" class="twitter text-white"
