<template>
    ...
    >
        ...
        <div class="section-title pb-4">
            ...
            MARQUE ESTA BICICLETA RECUPERADA
            </h4>
        </div>
        <div class="theme-btn bg-green universal-btn" id="button-3"  data-bs-toggle="modal" data-bs-target="#bike-back">
            <div id="circle"></div>
            <button>Esta bicicleta foi recuperada!</button>
        </div>
        </div>
        <div
            class="modal fade"
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-header">
                ...
                Ótimas notícias! Ainda bem que recuperou a sua bicicleta!
                </h5>
                <button
                type="button"
                class="btn-close"
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    >Como a conseguiu recuperar?</label
                    >
                    <textarea
                    rows="4"
                    v-model="recoveryMessage"
                    @blur="recoveryValid"
                    :class="recoveryWarn ? 'warning-border form-control font-size-textarea' : 'form-control font-size-textarea'"
                    ></textarea>
                    <p v-if="recoveryWarn" class="warning">*Por favor, preencha as informações de recuperação</p>
                </form>
                </div>
            </div>
            <!-- Modal -->
            ...
            >
                ...
                <div id="circle"></div>
                <button type="submit" @click="recoverBike">
                    <span>Assinalar como Recuperada</span>
                </button>
                </div>

                <div class="theme-btn-hover mt-2 p-0" id="button-hover">
        ...
        async recoverBike() {
            if(this.isValid) {
                ...
                const history = {
                    ...
                    recovery_message: this.recoveryMessage
                    },
                    type: 'recover',
                    user: this.userData,
                    bikes: this.bikeId
