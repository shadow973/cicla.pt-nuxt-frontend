  ...
  <div >
    <div class="admin-tab-content">
      <div class="section-title pb-4">
        <h4 class="them-title-black mb-2">My Ads</h4>
      </div>

      <!-- List Table-->
      <div class="dashboard-wrapper overflow-auto">
            ...
            <tr>
              ...
              <td data-title="Action">
                <div class="btns-actions">
                  <a class="btn-action btn-view" href="javascript:void(0)"
                    ><i class="fal fa-eye"></i
                  ></a>
                  <a class="btn-action btn-edit" href="javascript:void(0)"
                    ><i class="fal fa-file-edit"></i
                  ></a>
                  <a class="btn-action btn-delete" href="javascript:void(0)"
