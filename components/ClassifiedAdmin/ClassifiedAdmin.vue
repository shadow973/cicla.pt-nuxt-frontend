<template>
    <section class="section-padding theme-bg-light">
      <div class="theme-container">
        <div class="row">
          <div class="col-md-4">
            <div class="sideTabbar">
              <div class="title">Hello Bike Rider!</div>
              <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="false"
                  >
                    <i class="fal fa-layer-group"></i> &nbsp;&nbsp; My Ads
                  </button>
                </li>
                ...
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="false"
                  >
                    <i class="fal fa-biking"></i> &nbsp;&nbsp; Bike ownership
                    transfer
                  </button>
                </li>
          ...
          <div class="col-md-8">
            <div class="tab-content" id="adminTabContent">
              <AddNewPost class="tab-pane fade show active"
                id="dashboard"
                role="tabpanel"
                aria-labelledby="dashboard-tab" />

                <MyAds class="tab-pane fade" id="ads" role="tabpanel" aria-labelledby="ads-tab" />
                <OffersAndMessage class="tab-pane fade"
                    id="Messages"
                    role="tabpanel"
                    aria-labelledby="Messages-tab"/>

                <Payments class="tab-pane fade"
                id="Payments"
                role="tabpanel"
                aria-labelledby="Payments-tab"/>

                <BikeOwnerShip class="tab-pane fade"
                id="Ownership"
                role="tabpanel"
...
<script>
import AddNewPost from './ClassifiedTags/AddNewPost.vue'
import MyAds from './ClassifiedTags/MyAds.vue'
import OffersAndMessage from './ClassifiedTags/OffersAndMessage.vue'
import Payments from './ClassifiedTags/Payments.vue'
import BikeOwnerShip from './ClassifiedTags/BikeOwnerShip.vue'
export default {
    components: {
        AddNewPost,
        MyAds,
